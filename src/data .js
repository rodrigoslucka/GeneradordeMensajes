...
const cursos = [
  ...
  { 
    id: 85, 
    nombre: "MACROS Y LENGUAJE VISUAL BASIC EN MICROSOFT EXCEL (NIVEL BASICO)",
    add: false,
  },
  { 
    id: 86, 
    nombre: "MACROS Y LENGUAJE VISUAL BASIC EN MICROSOFT EXCEL (NIVEL INTERMEDIO)",
    add: false,
  },
  { 
    id: 87, 
    nombre: "MACROS Y LENGUAJE VISUAL BASIC EN MICROSOFT EXCEL (NIVEL AVANZADO)",
    add: false,
  },
  { 
    id: 88, 
  ...
  { 
    id: 96, 
    nombre: "NUEVAS TECNOLOGÍAS DE LA INFORMACIÓN Y LEGAL TECH JUDICIAL, SISTEMAS INFORMÁTICOS DEL ÓRGANO JUDICIAL (THOR, ODIN, SIREJ, SERVERO, SINAES Y JUSTICIA LIBRE)",
    add: false,
  },
  { 
    id: 97, 
